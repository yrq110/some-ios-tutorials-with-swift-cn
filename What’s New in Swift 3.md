...
>* 原文链接 : [What’s New in Swift 3](http://www.appcoda.com/swift3-changes/)
* 原文作者 : [COSMIN PUPĂZĂ](http://www.appcoda.com/author/cosminpupaza/)
...
**目录**
* [++ 与 -- 运算符](#ma-mi)
* [C语言风格的for循环已成为历史](#c-for)
* [将var从函数参数中移除](#var)
* [一致性的函数参数声明方式](#一致性的函数参数声明方式)
* [选择器字符串将失效](#选择器字符串将失效)
* [Key-paths字符串](#key-paths)
* [取消Foundation类型的NS前缀](#ns-foundation)
* [M_PI vs .pi](#pi)
* [GCD多线程](#gcd)
* [核心图形库(Core Graphics)现在更加Swifty](#cg-swifty)
* [动词 vs 名词 命名规范](#noun-verb)
* [Swift风格的API](#api)
* [枚举](#枚举)
* [@discardableResult](#discard)
* [总结](#总结)
